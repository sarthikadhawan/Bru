...
<!-- Mirrored from pages.revox.io/dashboard/3.0.0/html/corporate/notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Mar 2018 18:15:04 GMT -->
<head>
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
<meta charset="utf-8" />
<title>Pages - Admin Dashboard UI Kit - Progress Indicators</title>
...
<img width="35" height="35" src="assets/img/profiles/avatar_small.jpg" alt="" data-src="assets/img/
profiles/avatar_small.jpg" data-src-retina="assets/img/profiles/avatar_small2x.jpg">
...
<li class="nav-item">
<a class="btn btn-default btn-cons btn-rounded btn-notification-style active m-b-10" href="#loadingBar" role="tab" data-toggle="tab" data-type="position-bar">Bar</a>
</li>
<li class="nav-item">
<a class="btn btn-default btn-cons btn-rounded btn-notification-style m-b-10" href="#bouncyFlip" role="tab" data-toggle="tab" data-type="position-flip">Flip Bar</a>
</li>
<li class="nav-item">
<a class="btn btn-default btn-cons btn-rounded btn-notification-style m-b-10" href="#circleNotification" role="tab" data-toggle="tab" data-type="position-circle">Circle</a>
</li>
<li class="nav-item">
<a class="btn btn-default btn-cons btn-rounded btn-notification-style m-b-10" href="#simpleAlert" role="tab" data-toggle="tab" data-type="position-simple">Simple Alert</a>
</li>
</ul>
...
<input type="text" class="form-control notification-message" placeholder="Type your message here" value="This notification looks so perfect!" required>
</div>
...
<div>
<div class="profile-img-wrapper m-t-5 inline">
<img alt="Avatar" width="35" height="35" src="assets/img/profiles/avatar_small.jpg" data-src="assets/img/
profiles/avatar_small.jpg" data-src-retina="assets/img/profiles/avatar_small2x.jpg">
<div class="chat-status available">
</div>
</div>
...
<br>
<button title="" data-toggle="tooltip" class="btn btn-default tip m-b-5 m-r-5" type="button" data-original-title="Up here!">Top</button>
<button data-placement="right" title="" data-toggle="tooltip" class="btn btn-default tip m-b-5 m-r-5" type="button" data-original-title="Hello there!">Right</button>
<button data-placement="bottom" title="" data-toggle="tooltip" class="btn btn-default tip m-b-5 m-r-5" type="button" data-original-title="Look down!">Down</button>
<button data-placement="left" title="" data-toggle="tooltip" class="btn btn-default tip m-b-5 m-r-5" type="button" data-original-title="Over here!">Left</button>
<br>
</div>
</div>
...
<!-- Mirrored from pages.revox.io/dashboard/3.0.0/html/corporate/notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Mar 2018 18:15:11 GMT -->
</html>