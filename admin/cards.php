...
<!-- Mirrored from pages.revox.io/dashboard/3.0.0/html/corporate/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Mar 2018 18:15:44 GMT -->
<head>
...
<div class="card-header ">
<div class="card-title">Portlet One
</div>
<div class="card-controls">
<ul>
<li><a data-toggle="close" class="card-close" href="#"><i class="card-icon card-icon-close"></i></a>
...
<div class="card card-default">
<div class="card-header ">
<div class="card-title">Portlet Two
</div>
<div class="card-controls">
<ul>
<li><a data-toggle="close" class="card-close" href="#"><i class="card-icon card-icon-close"></i></a>
...
<div class="card card-transparent">
<div class="card-header ">
<div class="card-title">Portlet Four
</div>
</div>
<div class="card-block">
<h3>
...
<h3>
<span class="semi-bold">With</span> Separator</h3>
<p class="text-black hint-text">When it comes to digital design, the lines between functionality, aesthetics, and psychology are inseparably blurred. Without the constraints of the physical world, there’s no natural form to fall back on, and every bit of constraint and affordance must be introduced intentionally. Good design makes a product useful. A product is bought to be used.</p>
</div>
</div>
</div>
</div>
...
<div class="col-lg-4">
<div id="card-error" class="card card-default">
<div class="card-header ">
<div class="card-title">Portlet Title
</div>
<div class="card-controls">
...
<div class="card card-default bg-danger" data-pages="card">
<div class="card-header ">
...
<div class="card card-default bg-success" data-pages="card">
<div class="card-header ">
<div class="card-title">Draggable Portlet
</div>
<div class="card-controls">
