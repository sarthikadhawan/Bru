...
<div class=" container container-fixed-lg">
        <h4 style="background-color: #00A0B0; color:white; font-family: 'Montserrat';padding:10px;">  Application History >></h5>
    ...
    <tbody>
        ...
        if (mysqli_num_rows($result) > 0) {
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<tr><td>" . $row["name"] . "</td><td> " . $row["start_date"]. "</td><td>" . $row["end_date"]. "</td><td><a href='/waiting-list.php?id=" . $row['id'] . "'>Waiting List</a></td><td>" . $status . "</td></tr>";
                }
         } else {
               //echo "0 results";
         }
